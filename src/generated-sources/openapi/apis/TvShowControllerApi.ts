 ...
 * 
 */
export class TvShowControllerApi extends runtime.BaseAPI {

    /**
     */
    async getRecent1Raw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<PageShowEntity>> {
    ...
    /**
     */
    async getRecent1(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<PageShowEntity> {
    ...
    async getSeasonsRaw(requestParameters: GetSeasonsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Array<SeasonEntity>>> {
        ...
        const response = await this.request({
            path: `/TVShows/{id}/seasons`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
    ...
    async getTVShowRaw(requestParameters: GetTVShowRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ShowEntity>> {
        ...
        const response = await this.request({
            path: `/TVShows/{id}`.replace(`{${"id"}}`, encodeURIComponent(String(requestParameters.id))),
            method: 'GET',
            headers: headerParameters,
            query: queryParameters,
        }, initOverrides);
